-- Keep the exact prior-attempt failure available to the next durable retry.
-- One invocation performs generation and audits only; model corrections occur
-- on later queue attempts so Hobby-plan functions stay below five minutes.
